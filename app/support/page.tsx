...
export const Route = createFileRoute()({
  head: () => ({
    meta: [
      { title: "Support — JAS geomatics  India | Help Centre, Docs, Downloads" },
      { name: "description", content: "Guides, firmware downloads, tutorials and pan-India technical support for JAS geomatics  products." },
      { property: "og:title", content: "Support — JAS geomatics  India" },
      { property: "og:description", content: "Docs, downloads, tutorials and pan-India technical support." },
    ],
  }),
      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {cards.map((c, i) => (
          <motion.a
            ...
            whileHover={{ y: -6 }}
            className="group relative overflow-hidden rounded-3xl glass p-6 hover:glow-brand transition"
          >
